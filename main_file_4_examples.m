...
switch inp
    ...
    case 2
        ibipp('Example_pics\hammerhead.png',200,0.5,[2 1 1 2],...
            [180 180 180 180],'optimization','BESO','filterRadius',3)
    case 3
        ibipp('Example_pics\2point.png',300,0.45,[1 1],[0 0],'optimization',...
            'levelset','tau',5e-5,'preserveLoad',1,'preserveSupport',1)
    case 4
        ibipp('Example_pics\half_spanner.png',250,0.5,'pressure',[1,1],...
